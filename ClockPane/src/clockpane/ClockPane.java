/**
 * The program displays a clock for the current time using no-arg constructor
 * and displays a clock for the specified hour, minute, and second using
 * another constructor.
 */
package clockpane;
